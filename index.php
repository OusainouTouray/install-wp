...
if ( empty( $_GET ) && end( ( explode( '/' , trim($_SERVER['REQUEST_URI'], '/') ) ) ) == 'install-wp' ) {
...
<html xmlns="http://www.w3.org/1999/xhtml" lang="fr">
	<head>
		<meta charset="utf-8" />
		<title>StackPress WordPress Installation</title>
		<!-- Get out Google! -->
	...
	<h1 id="logo"><a href="https://stackpress.net/">WordPress</a></h1>
		<?php
		...
		if ( is_writable( $parent_dir ) ) { ?>
			...
			<form method="post" action="">
				...
				<p><?php echo _('This file must be in the install-wp folder and not be present in the root of your project.');?></p>

				<h1><?php echo _('Database Information');?></h1>
				<p><?php echo _( "Below you should enter your database connection details you created in your StackPress account." ); ?></p>
				...
				<table class="form-table">
					...
					<tr>
						...
						<td><input name="uname" id="uname" type="text" size="25" value="" class="required" /></td>
					...
					<tr>
						...
						<td><?php echo _( 'Do not change this !' ); ?></td>
					</tr>
					<tr>
				...
				<p><?php echo _('Don\'t worry, you will be able to change it later.');?></p>
				...
				<p><?php echo _('We have added security and performance plugins we highly recommend. You can add your own if you like.');?></p>
				<table class="form-table">
					<tr>
						<th scope="row">
						...
						<td>
							<input name="plugins" type="text" id="plugins" size="50" value="wp-simple-firewall; sucuri-scanner; backupwordpress; wp-super-cache; rocket-lazy-load; akismet"  />
					...
					<tr>
						<th scope="row">
							...
							<p><?php echo _('Zip Archives have to be in the <em>plugins</em> folder at the <em>install-wp</em> root folder.');?></p>
						</th>
